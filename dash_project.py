...
year = [2006,1985,2008,2009,1996,1989,1984,2005,1999,2007,2007,2010,2013,2004,1990,1988,1988,2002,2001,2011,1988,1988]
...
platform = ["Wii","NES","GB","DS","X360","PS3","PS2","SNES","GBA","3DS","PS4","N64","PS","XB","PC","2600","PSP"]
...
def update_figure(selected_year):
    ...
    fig_publisher.update_layout(transition_duration=500,template="plotly_dark",title="Vendas por Publicadora em Norte América e Europa")
...
def update_figure(selected_year):
    ...
    fig_publisher2.update_layout(transition_duration=500,template="plotly_dark",title="Vendas por Publicadora em Japão e Outras Regiões")
